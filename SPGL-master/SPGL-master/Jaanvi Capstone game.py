...
hangman_stand = Hangman_Images("hangman_stand.gif","white", -325.0, 110.0)
hangman_face = Hangman_Images("hangman_face.gif","white", -247.0, 184.0)
hangman_body = Hangman_Images("hangman_body.gif","white", -235.0, 115.0)
hangman_hands = Hangman_Images("hangman_hands.gif","white", -245.0, 130.0)
hangman_legs = Hangman_Images("hangman_legs.gif","white", -235.0, 52.0)
...
correct_word_label = spgl.Label(" ", "red", 0.0,95.0)
